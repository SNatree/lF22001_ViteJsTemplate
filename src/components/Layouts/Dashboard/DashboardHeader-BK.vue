            ...
            <a-row type="flex">
                ...
                <a-col :span="24" :md="6">
                    ...
                    <div class="ant-page-header-heading">
                        <span class="ant-page-header-heading-title">{{ routeName }}</span>
                    </div>
                    <!-- / Header Page Title -->
                </a-col>
                <!-- / Header Breadcrumbs & Title Column -->
                ...
                <a-col :span="24" :md="18" class="header-control">
                    ...
                    <a-button type="link" ref="secondarySidebarTriggerBtn" @click="toggleSettingsDrawer">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                    ...
                    <a-button type="link" class="sidebar-toggler" @click="toggleSidebarCollapse">
...
export default defineComponent({
    props: {
        ...
        showSettingsDrawer: { type: Boolean, default: false },
        notificationsData: { type: Array, default: () => notificationsData },
    },
    setup(props, { emit, slots, attrs }) {
        ...
        const resizeEventHandler = () => {
            dataState.top = dataState.top ? 0 : -0.01
        }
        ...
        const toggleSettingsDrawer = () => {
            emit('update:showSettingsDrawer', !props.showSettingsDrawer)
            resizeEventHandler()
        }

        onMounted(() => {
            wrapper = document.getElementById('layout-dashboard')
        })
        return { ...toRefs(dataState), routeName, toggleSidebarCollapse, toggleSettingsDrawer }
    },
})
</script>
